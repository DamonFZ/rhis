        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center aspect-[4/5]">
            <div class="mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#1E4D7B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
            </div>
    ...
    <div class="px-8 mt-10 grid grid-cols-2 gap-y-10 gap-x-6">
        ...
        <div class="flex flex-col items-center cursor-pointer">
            <div class="w-14 h-14 mb-2 flex items-center justify-center bg-[#F0F8F4] rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-[#1E4D7B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 0 002 2h10a2 2 0 002-2V7a2 0 00-2-2h-2M9 5a2 0 002 2h2a2 0 002-2M9 5a2 0 012-2h2a2 0 012 2" />
                </svg>
            </div>
        ...
        <div class="flex flex-col items-center cursor-pointer">
            <div class="w-14 h-14 mb-2 flex items-center justify-center bg-[#FFF5E8] rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-[#1E4D7B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 0 00-2 2v6a2 2 0 002 2h2a2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0 a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 0 012-2h2a2 2 0 012 2v14a2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
            </div>
        ...
        <div class="flex flex-col items-center cursor-pointer">
            <div class="w-14 h-14 mb-2 flex items-center justify-center bg-[#F3E8FA] rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-[#1E4D7B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 0 00-2-2H5a2 0 00-2 2v12a2 0 002 2z" />
                </svg>
            </div>
